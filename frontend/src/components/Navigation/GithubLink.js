      ...
      <div className=" dropdown-menu" ref={dropdownMenuRef} style={{ width: '200px' }}>
        ...
        <div className="dropdown-menu-item">
          <p className="github-a">
            <a target="_blank" href='https://github.com/tonyngophd/tripcamp-react-express-project'>Github Repo</a>
          </p>
        </div>
        <hr className="hr" />
        <div className="dropdown-menu-item">
        ...
        <div className="dropdown-menu-item">
          <p className="github-a">
            <a target="_blank" href='https://github.com/tonyngophd'>Tony Ngo</a>
          </p>
        </div>
        <div className="dropdown-menu-item">
          <p className="github-a">
